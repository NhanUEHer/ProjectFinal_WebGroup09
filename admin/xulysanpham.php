...
<?php
	if(isset($_POST['themsanpham'])){
		...
		$sql_insert_product = mysqli_query($con,"INSERT INTO tbl_sanpham(sanpham_name,sanpham_chitiet,sanpham_mota,sanpham_gia,sanpham_giakhuyenmai,sanpham_soluong,sanpham_image,category_id,sanpham_active,sanpham_hot) values ('$tensanpham','$chitiet','$mota','$gia','$giakhuyenmai','$soluong','$hinhanh','$danhmuc','$active','$hot')");
		...
		$path = '../uploads/';
		if($hinhanh==''){
			$sql_update_image = "UPDATE tbl_sanpham SET sanpham_name='$tensanpham',sanpham_chitiet='$chitiet',sanpham_mota='$mota',sanpham_gia='$gia',sanpham_giakhuyenmai='$giakhuyenmai',sanpham_soluong='$soluong',category_id='$danhmuc',sanpham_active='$active',sanpham_hot='$hot' WHERE sanpham_id='$id_update'";
		}else{
			move_uploaded_file($hinhanh_tmp,$path.$hinhanh);
			$sql_update_image = "UPDATE tbl_sanpham SET sanpham_name='$tensanpham',sanpham_chitiet='$chitiet',sanpham_mota='$mota',sanpham_gia='$gia',sanpham_giakhuyenmai='$giakhuyenmai',sanpham_soluong='$soluong',sanpham_image='$hinhanh',category_id='$danhmuc',sanpham_active='$active',sanpham_hot='$hot' WHERE sanpham_id='$id_update'";
		}
		...
		<?php
			if(isset($_GET['quanly'])=='capnhat'){
				...
				<form action="" method="POST" enctype="multipart/form-data">
					...
					<img src="../uploads/<?php echo $row_capnhat['sanpham_image'] ?>" height="50%" width="50%"><br>
					<label>Giá</label>
			...
			<div class="col-md-8">
				...
				<table class="table table-bordered ">
					...
					<tr>
						...
						<td><img src="../uploads/<?php echo $row_sp['sanpham_image'] ?>" height="100%" width="100%"></td>
						...
						<td><?php echo $row_sp['sanpham_active']== 1 ? 'Đã Active' : 'Chưa Active'; ?></td>
						<td><?php echo $row_sp['sanpham_hot']== 1 ? 'Có' : 'Không'; ?></td>
