				...
				<div class="agileinfo-ads-display col-lg-9">
					...
					?>
						...
						<div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mb-4">
							...
							<div class="row">
								<?php
									$sql_product = mysqli_query($con,"SELECT * FROM tbl_sanpham WHERE sanpham_active='1'ORDER BY sanpham_id DESC");
								...
								<div class="col-md-4 product-men mt-5">
									<div class="men-pro-item simpleCart_shelfItem">
										<div class="men-thumb-item text-center">
											<img src="images/<?php echo $row_sanpham['sanpham_image'] ?>" height="100%" width="100%" alt="">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="?quanly=chitietsp&id=<?php echo $row_sanpham['sanpham_id']?>" class="link-product-add-cart" style="background:#ffd400; color:#000;">Xem sản phẩm</a>
												</div>
											</div>
										</div>
											...
											<div class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
												<form action="?quanly=giohang" method="post">
													<fieldset>
														...
														<input type="submit" name="themgiohang" value="Thêm vào giỏ hàng" class="button" style="background:#ffd400; color:#000;"/>
													</fieldset>
												</form>
					...
					<div class="side-bar p-sm-4 p-3" >
						<div class="search-hotel border-bottom py-2" >
							...
							<form action="index.php?quanly=timkiem" method="POST">
								<input type="search" name="search-product"  placeholder="Sản phẩm..." aria-label="Search" required="">
								<input style="background-color:#ffd400; color:#000;" name="search_button" type="submit" value="" >
							</form>
						</div>
						<!-- price -->
						...
						<div class="left-side border-bottom py-2">
							...
							<ul>
								...
								<li>
									<!-- <input type="checkbox" class="checked"> -->
									<span class="span"><a style="color: #000;" href="danhmuc.php?id=<?php echo $row_category_sidebar['category_id']?>"><?php echo $row_category_sidebar['category_name']?></a></span>
								</li>
								<?php
									}
								?>
