<?php
	...
	?>
	<div class="navbar-inner" style="background-color:#ffe562; ">
		<div class="container">
			<nav class="navbar navbar-expand-lg navbar-light" >
				<div class="agileits-navi_search">
					<form action="#" method="post">
						<select onchange="window.location.href=this.value;" id="agileinfo-nav_search" name="agileinfo_search" class="border " required="">
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav ml-auto text-center mr-xl-5">
						...
						<?php
							$sql_category_danhmuc = mysqli_query($con,"SELECT * FROM tbl_category WHERE category_menu ='1' ORDER BY category_id DESC");
						...
						<li class="nav-item dropdown mr-lg-2 mb-lg-0 mb-2">
							...
							<div class="dropdown-menu">
								...
								<a class="dropdown-item" href="#">Kiểm tra đơn hàng</a>
