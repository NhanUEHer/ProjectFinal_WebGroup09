<?php
	if(isset($_POST['themgiohang'])){
		...
		// }
			...
			$sql_khachhang = mysqli_query($con,"INSERT INTO tbl_khachhang(cus_name,cus_phone,cus_email,note,cus_addr,giaohang,password) values ('$cus_name','$cus_phone','$cus_email','$note','$cus_addr','$giaohang','$password')");
			...
			if($sql_khachhang){
				...
				$_SESSION['dangnhap_home'] = $row_khachhang['cus_name'];
				...
				<div class="table-responsive">
					...
					<table class="timetable_sub">
						...
						<tbody>
                            ...
                            ?>
                            <tr>
                                <td colspan="7">Tổng tiền : <?php echo number_format($total).'đ'?></td>
                            </tr>
                            <tr>
							...
							<div class="information-wrapper">
								<div class="first-row">
									<div class="controls form-group">
										<input class="billing-address-name form-control" type="text" name="cus_name" placeholder="Tên khách hàng" required="">
									</div>
									<div class="w3_agileits_card_number_grids">
										<div class="w3_agileits_card_number_grid_left form-group">
											<div class="controls">
												<input type="text" class="form-control" placeholder="Số điện thoại" name="cus_phone" required="">
											</div>
										</div>
										<div class="w3_agileits_card_number_grid_right form-group">
											<div class="controls">
												<input type="text" class="form-control" placeholder="Địa chỉ" name="cus_addr" required="">
											</div>
										</div>
									</div>
									<div class="controls form-group">
										<input type="text" class="form-control" placeholder="Email" name="cus_email" required="">
									</div>
									<div class="controls form-group">
										<input type="text" class="form-control" placeholder="Nhập mã xác nhận (Ghi nhớ mã này để tra cứu đơn hàng)" name="password" required="">
									</div>
									<div class="controls form-group">
